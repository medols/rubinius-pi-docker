...
mkdir -p /opt/rubinius/src && cd /opt/rubinius/src
git clone https://github.com/medols/rubinius.git && cd rubinius
...
LANG=en_US.UTF-8 LANGUAGE=en_US.UTF-8 LC_ALL=en_US.UTF-8 rake vm:test
